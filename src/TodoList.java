...
public class TodoList extends JFrame {
    ...
    public TodoList() {
        ...
        // Removemos a ação de marcar uma tarefa como concluída com um clique simples
        // markDoneButton.addActionListener(e -> {
        //     markTaskDone();
        // });

        // Adicionamos um MouseListener para tratar o evento de duplo clique no botão "Concluir"
        ...
        // Adicione um ActionListener ao JComboBox para filtrar as tarefas
    ...
    private void deleteTask() {
        ...
        int choice = JOptionPane.showConfirmDialog(null, "Deseja realmente apagar?", "Confirmação", JOptionPane.YES_NO_OPTION);
